    ...
    return (
        <div className="container">
            <div className="row mt-5 mb-5 p-5 text-center">
                <h1 className="fs-2 fw-normal" style={{lineHeight: "3rem"}}>We pioneered the discount broking model in India.
                <br></br>Now, we are breaking ground with our technology.</h1>
            </div>

            <div className="row mt-5 mb-5 p-5 text-center border-top">
                <div className="col-6 text-muted p-5" style={{lineHeight: "2rem", fontSize: "1.1rem"}}>
                ...
                <div className="col-6 text-muted fs-5 p-5" style={{lineHeight: "2rem", fontSize: "1.3rem"}}>
